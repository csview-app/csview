...
public class CocoaUIEnhancer extends CocoaUtil {
    ...
    private void init() throws SecurityException, NoSuchMethodException, IllegalArgumentException,
        ...
        args = makeArgs(wrapPointer(cls), SWT_OBJECT, wrapPointer(size), (byte) align, types);
    ...
    public CocoaUIEnhancer() {
        ...
        try {
            if (productName != null) {
                ...
                if (format != null)
                    fAboutActionName = MessageFormat.format(format, productName);
            }
        ...
        if (productName != null) {
            try {
                ...
                if (format != null)
                    fHideActionName = MessageFormat.format(format, productName);
            ...
            try {
                ...
                if (format != null)
                    fQuitActionName = MessageFormat.format(format, productName);
    ...
    public void earlyStartup() {
        ...
        display.syncExec(this::startupInUI);
    }
    ...
    private void createDelegate() throws SecurityException, NoSuchMethodException,
        ...
        Object object = method.invoke(OS.class, CocoaUIEnhancer.this);
    ...
    static int actionProc(int id, int sel, int arg0) throws Exception {
        return (int) actionProc(id, sel, (long) arg0);
    }
